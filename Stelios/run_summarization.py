...
import numpy as np
# TODO: Replace namedtuple by a Config class
...
# Define flags
# TODO: Replace Flags with Argparse
FLAGS = tf.app.flags.FLAGS

# Where to find data
# SS: e.g. this is creating the flags "--data_path" and "--vocab_path"
tf.app.flags.DEFINE_string(
    'data_path', '', 'Path expression to tf.Example datafiles. Can include\
     wildcards to access multiple datafiles.')
tf.app.flags.DEFINE_string(
...
def calc_running_avg_loss(loss, running_avg_loss, summary_writer, step,
                          decay=0.99):
    ...
    Args:
      ...
      decay: rate of exponential decay; float in [0,1]. Larger = smoother
    ...
    if running_avg_loss == 0:  # on the first iteration just take the loss
        ...
        running_avg_loss = decay * running_avg_loss + (1 - decay) * loss

    # TODO: Rearrange these 6 lines into a more meaningful order
...
def restore_best_model():
    ...
    # This saver saves all variables that exist, including Adagrad variables
...
def main(unused_argv):
    ...
    if hps.mode == 'train':
        ...
        decode_model_hps = hps  # This will be the hyperparames for the decoder
